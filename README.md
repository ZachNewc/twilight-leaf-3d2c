...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/twilight-leaf-3d2c#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-leaf-3d2c
```

A live public deployment of this template is available at [https://twilight-leaf-3d2c.templates.workers.dev](https://twilight-leaf-3d2c.templates.workers.dev)
